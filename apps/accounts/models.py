...
class User(AbstractUser):
    ...
    agency_tagline = models.CharField(max_length=200, blank=True)
    is_featured_agency = models.BooleanField(default=False)
    featured_priority = models.PositiveSmallIntegerField(default=0)
